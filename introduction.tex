...
In the real world, rapid rotations such as the ones in the example scenes would create centrifugal force,
which would lead to air pressure differing in different parts of the room,
which would in turn change the behaviour of sound waves bouncing around the room.
