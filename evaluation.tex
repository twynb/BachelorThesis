...
\newline
The other two test cases are run using 1 million rays per sample for the performance tests
and 5 million rays per sample for comparing values,
...
For a 1 second sample at 44100 KHz and a roughly 2 minute IR calculation time
(rounded down from the snapshot method test results below),
this would take \(44100 \cdot 2 m = 88200 m = 1470 h = 61.25 d\).
Running simulations for such scenes would require optimisations or much stronger hardware
